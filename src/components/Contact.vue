<template>
    <div :class="{ flipped: isFlipped }" class="card text-white bg-black mb-3 border-0 mt-4 about-section">
        ...
        <div class="card-back">
            <div class="card-header">Contact Form | Email: <a class="email" href='&#109;ai&#108;&#116;o&#58;%64j&#64;&#37;&#54;4%&#54;Ac&#121;&#112;h&#101;rs&#46;com'>d&#106;&#64;d&#106;c&#121;phers&#46;com</a></div>
            <div class="card-body">
                <form
                    class="text-center"
                ...
                <input
                    ...
                    required
                />
                <textarea class="form-control mb-3" v-model="contactForm.msg" placeholder="Message"></textarea>
